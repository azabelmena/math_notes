...
for which  $n \geq N$ implies that either  $x_n \geq M$, or  $x_n \leq M$. Then we write 
 ...
 \begin{example}
     \begin{enumerate}[label=(\arabic*)]
         \item Let $\{x_n\}$ be a sequence in  $\Q$, then every real number is a subsequential 
             limit, and $\limsup{x_n}=\infty$ and  $\liminf{x_n}=-\infty$.

         \item Let  $\{x_n\}=\{\frac{(-1)^n}{1+\frac{1}{n}}\}$; then $\limsup{x_n}=1$ and 
             $\liminf{X_n}=-1$ as  $n \rightarrow \infty$.

         \item For a sequence  $\{x_n\}$ in  $\R$,  $\lim{x_n}=x$ if and only if 
