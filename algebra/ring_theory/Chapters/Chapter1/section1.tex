...
\begin{example}\label{1.5}
    \begin{enumerate}
        ...
        \item[(4)] If $F$ is a field, then any subring of $F$ is also an
        ...
        \item[(5)] The set $\Z[\sqrt{D}]=\{a+b\sqrt{D} : a,b \in \Z\}$ is a
            ...
            \begin{equation*}
                \Z[\frac{1+\sqrt{D}}{2}]=\{a+b\frac{1+\sqrt{D}}{2} : a,b \in \Z\}
            \end{equation*}
        ...
        \item[(6)] Consider $\Q(\sqrt{D})$ where $D$ is squarefree. We define
            the  \textbf{field norm} $N:\Q(\sqrt{D}) \xrightarrow{} D$ by taking
