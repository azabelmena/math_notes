...
\begin{figure}
  \centering
  \includegraphics[scale=0.2]{figures/parts/group_theory/D_14_symm.eps}
...
a rotation if the vertices by an angle of  $\frac{2\pi}{n}$. Now, define
the ``identity'' symmetry $e:i \rightarrow i$. Then notice that
\begin{equation*}
  t^2:i \xrightarrow{} -i \xrightarrow{} -(-i)=i \text{ and }
  r^n:i \xrightarrow{} i+1 \xrightarrow{} \dots \xrightarrow{} i+n
  \equiv i \mod{n}
\end{equation*}
So $t^2=r^n=e$. (moreover, if we treat $e$ as a rotation of the veritces by
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.2]{figures/parts/group_theory/D_14.eps}
