...
\begin{example}[Groups of order $pq$, where $p<q$]\label{4.13}
...
\begin{example}[Groups of order $30$]\label{4.14}
...
\begin{example}[Groups of order $12$]\label{4.15}
...
\begin{example}[Groups of order $p^2q$, where $p$, and $q$ are distinct]\label{4.16}
