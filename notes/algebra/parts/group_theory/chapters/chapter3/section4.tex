...
\begin{theorem}[The First Isomorphism Theorem]\label{theorem_3.4.1}
...
\begin{theorem}[The Second Isomorphism Theorem]\label{theorem_3.4.4}
...
\begin{theorem}[The Third Isomorphism Theorem]\label{theorem_3.4.3}
...
\begin{theorem}[The Fourth Isomorphism Theorem]\label{theorem_3.4.2}
