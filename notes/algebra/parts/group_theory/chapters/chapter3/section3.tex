...
\begin{theorem}[Lagrange's Theorem.]\label{theorem_3.3.1}
...
\begin{proposition}\label{proposition_3.3.2}
...
\begin{example}\label{example_3.6}
  \begin{enumerate}
...
\begin{theorem}\label{proposition_3.3.6}
