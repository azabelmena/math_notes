...
\begin{proposition}\label{proposition_6.1.2}
...
\begin{proposition}\label{proposition_6.1.5}
...
\begin{theorem}[The Extended Euclidean Algorithm]\label{theorem_6.1.6}
...
\begin{proposition}\label{proposition_6.1.7}
