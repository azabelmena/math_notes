...
\begin{proposition}\label{proposition_7.3.1}
...
\begin{proposition}\label{proposition_7.3.2}
...
\begin{example}\label{example_7.4}
    \begin{enumerate}
        \item[(1)] The polynomial $x^3+3x-1$ is irreducible in  $\Z[x]$. By
            Gauss' proposition, it suffices to show that it has no roots in $\Q$.
...
\begin{proposition}\label{proposition_7.3.3}
